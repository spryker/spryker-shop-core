...
namespace SprykerShop\Yves\ShopContext\Communication\Provider;
...
{
    /**
     * @var \SprykerShop\Yves\ShopContextExtension\Dependency\Plugin\ShopContextExpanderPluginInterface[]
     */
    protected $shopContextExpanderPlugins;

    /**
     * @param \SprykerShop\Yves\ShopContextExtension\Dependency\Plugin\ShopContextExpanderPluginInterface[] $shopContextExpanderPlugins
     */
