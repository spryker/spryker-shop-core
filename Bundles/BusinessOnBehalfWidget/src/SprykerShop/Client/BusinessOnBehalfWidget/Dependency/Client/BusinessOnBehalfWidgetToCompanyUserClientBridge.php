...
class BusinessOnBehalfWidgetToCompanyUserClientBridge implements BusinessOnBehalfWidgetToCompanyUserClientInterface
{
    /**
    ...
    {
        return $this->companyUserClient->findCompanyUserCollectionByCustomerId($customerTransfer);
    }
}
