...
class QuoteRequestCartWidget extends AbstractWidget
{
    ...
    {
        return '@QuoteRequestWidget/views/quote-request/update-quote-request.twig';
    }
    ...
    {
        return (bool)$quoteTransfer->getQuoteRequestReference() && !$quoteTransfer->getQuoteRequestVersionReference();
    }
}
