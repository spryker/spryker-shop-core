...
namespace SprykerShop\Yves\DiscountWidget\Plugin;
...
use SprykerShop\Yves\CartPageExtension\Dependency\Plugin\CodeHandlerPluginInterface;

class GiftCardCodeHandler extends AbstractPlugin implements CodeHandlerPluginInterface
{
