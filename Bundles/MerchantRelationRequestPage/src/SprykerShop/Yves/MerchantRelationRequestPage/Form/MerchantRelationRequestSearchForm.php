 ...
 */
class MerchantRelationRequestSearchForm extends AbstractType
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const OPTION_STATUS_CHOICES = 'option_status_choices';
     ...
     * @var string
     */
    public const FORM_NAME = 'merchantRelationRequestSearchForm';
    ...
    protected function addFiltersField(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            MerchantRelationRequestSearchFiltersSubForm::class,
            [
                ...
                static::OPTION_STATUS_CHOICES => $options[static::OPTION_STATUS_CHOICES],
            ],
        );
