...
namespace SprykerShop\Yves\ProductSetDetailPage\ResourceCreator;
...
class ProductSetDetailPageResourceCreator extends AbstractResourceCreator
{
    ...
    {
        $bundleControllerAction = new BundleControllerAction('ProductSetDetailPage', 'Detail', 'index');
