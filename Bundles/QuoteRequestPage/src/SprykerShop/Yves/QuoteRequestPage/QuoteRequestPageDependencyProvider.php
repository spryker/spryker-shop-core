...
use SprykerShop\Yves\QuoteRequestPage\Dependency\Client\QuoteRequestPageToGlossaryStorageClientBridge;
...
class QuoteRequestPageDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function addGlossaryStorageClient(Container $container): Container
    {
        $container[static::CLIENT_GLOSSARY_STORAGE] = function (Container $container) {
            return new QuoteRequestPageToGlossaryStorageClientBridge($container->getLocator()->glossaryStorage()->client());
        };
