...
class QuoteRequestPageDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public const PLUGIN_QUOTE_REQUEST_FORM_METADATA_FIELD = 'PLUGIN_QUOTE_REQUEST_FORM_METADATA_FIELD';
    ...
    {
        $container[static::PLUGIN_QUOTE_REQUEST_FORM_METADATA_FIELD] = function () {
