...
namespace SprykerShop\Yves\HealthCheckPage\Plugin\Router;

use Spryker\Yves\Router\Plugin\RouteProvider\AbstractRouteProviderPlugin;
use Spryker\Yves\Router\Route\RouteCollection;

class HealthCheckPageRouteProviderPlugin extends AbstractRouteProviderPlugin
{
    ...
    {
        $route = $this->buildRoute('/health-check', 'HealthCheckPage', 'Index', 'indexAction');
