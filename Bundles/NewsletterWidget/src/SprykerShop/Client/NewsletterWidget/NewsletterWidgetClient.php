...
/**
 * @method \SprykerShop\Client\NewsletterWidget\NewsletterWidgetFactory getFactory()
 */
class NewsletterWidgetClient extends AbstractClient implements NewsletterWidgetClientInterface
{
    /**
     * {@inheritdoc}
     *
     ...
     */
    // TODO: refactor to have the newsletter type as a parameter instead of method name
