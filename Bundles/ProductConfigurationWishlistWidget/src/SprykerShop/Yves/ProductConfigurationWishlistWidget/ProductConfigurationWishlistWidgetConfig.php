...
class ProductConfigurationWishlistWidgetConfig extends AbstractBundleConfig
{
    /**
     ...
     * @var string
     */
    protected const SOURCE_TYPE_WISHLIST_DETAIL = 'SOURCE_TYPE_WISHLIST_DETAIL';
     ...
     * @return string
     */
    public function getWishlistSourceType(): string
    {
        return static::SOURCE_TYPE_WISHLIST_DETAIL;
    }
