...
class QuoteItemCartNoteForm extends AbstractType
{
    ...
    {
        $builder->setAction(CartNotesWidgetControllerProvider::ROUTE_CART_NOTES_ITEM);
    ...
    protected function addCartNoteField(FormBuilderInterface $builder)
    {
        $builder->add(static::FIELD_CART_NOTE, TextareaType::class, [
            'label' => 'cart_notes.item_form.enter_note',
            'empty_data' => 'cart_notes.item_form.placeholder',
            'required' => false,
        ]);
