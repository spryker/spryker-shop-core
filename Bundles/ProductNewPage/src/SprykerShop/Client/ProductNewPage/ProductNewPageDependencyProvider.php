...
use SprykerShop\Client\ProductNewPage\Plugin\Elasticsearch\Query\NewProductsQueryPlugin;
...
class ProductNewPageDependencyProvider extends AbstractDependencyProvider
{
