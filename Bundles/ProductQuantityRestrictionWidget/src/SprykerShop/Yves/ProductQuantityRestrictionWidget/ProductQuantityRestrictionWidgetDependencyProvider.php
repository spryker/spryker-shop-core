...
use SprykerShop\Yves\ProductQuantityRestrictionWidget\Dependency\Client\ProductQuantityRestrictionWidgetToProductQuantityStorageClientBridge;
use SprykerShop\Yves\ProductQuantityRestrictionWidget\Dependency\Service\ProductQuantityRestrictionWidgetToProductQuantityServiceBridge;

class ProductQuantityRestrictionWidgetDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function addProductQuantityStorageClient(Container $container): Container
    {
        $container->set(static::CLIENT_PRODUCT_QUANTITY_STORAGE, function (Container $container) {
            return new ProductQuantityRestrictionWidgetToProductQuantityStorageClientBridge(
    ...
    protected function addProductQuantityService(Container $container): Container
    {
        $container->set(static::SERVICE_PRODUCT_QUANTITY, function (Container $container) {
            return new ProductQuantityRestrictionWidgetToProductQuantityServiceBridge(
