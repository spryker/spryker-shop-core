...
namespace SprykerShop\Zed\MultiCartPage\Dependency\Client;

class MultiCartPageToMessengerClientBridge implements MultiCartPageToMessengerClientInterface
{
    /**
