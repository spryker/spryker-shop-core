...
namespace SprykerShop\Client\NewsletterPage\Model;
...
class SubscriptionRequestLogic implements SubscriptionRequestLogicInterface
{
    /**
    ...
    protected function addEditorialNewsletterType(NewsletterSubscriptionRequestTransfer $subscriptionRequest)
    {
        ...
        $newsletterType->setName(NewsletterPageConstants::EDITORIAL_NEWSLETTER);
