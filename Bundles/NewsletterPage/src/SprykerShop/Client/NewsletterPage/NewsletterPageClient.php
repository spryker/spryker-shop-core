...
/**
 * @method \SprykerShop\Client\NewsletterPage\NewsletterPageFactory getFactory()
 */
class NewsletterPageClient extends AbstractClient implements NewsletterPageClientInterface
{
    /**
     * {@inheritdoc}
     *
