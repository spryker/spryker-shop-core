...
namespace SprykerShop\Yves\ProductWidget\Plugin\FeaturedProductWidget;

use Spryker\Yves\Kernel\Widget\AbstractWidgetPlugin;
use SprykerShop\Yves\FeaturedProductWidget\Dependency\Plugin\ProductWidget\ProductWidgetPluginInterface;
