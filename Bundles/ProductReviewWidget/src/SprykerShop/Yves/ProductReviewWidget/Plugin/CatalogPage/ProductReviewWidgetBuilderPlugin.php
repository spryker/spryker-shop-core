...
class ProductReviewWidgetBuilderPlugin extends AbstractWidgetBuilderPlugin
{

    const NAME = 'productReview';
    const TEMPLATE = '@ProductReviewWidget/_catalog-page/product-review.twig';
